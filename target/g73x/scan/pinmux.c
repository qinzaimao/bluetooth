...
struct aic_pinmux aic_pinmux_config[] = {
    ...
    /* qspi1 */
    {3, PIN_PULL_DIS, 3, "PD.4"},
    {3, PIN_PULL_DIS, 3, "PD.5"},
    {3, PIN_PULL_DIS, 3, "PD.6"},
    {3, PIN_PULL_DIS, 3, "PD.7"},
    {3, PIN_PULL_DIS, 3, "PD.8"},
    {3, PIN_PULL_DIS, 3, "PD.9"},
#endif
#ifdef AIC_USING_QSPI2
    /* qspi2 */
    {2, PIN_PULL_DIS, 3, "PE.12"},
    {2, PIN_PULL_DIS, 3, "PE.13"},
    {2, PIN_PULL_DIS, 3, "PE.14"},
    {2, PIN_PULL_DIS, 3, "PE.15"},
    {2, PIN_PULL_DIS, 3, "PE.16"},
    {2, PIN_PULL_DIS, 3, "PE.17"},
#endif

...
#ifndef LPKG_LVGL_DRAW_THREAD_STACK_SIZE
#ifndef LPKG_LVGL_THREAD_STACK_SIZE
    #define LPKG_LVGL_DRAW_THREAD_STACK_SIZE (4096 * 2)
#else
    #define LPKG_LVGL_DRAW_THREAD_STACK_SIZE LPKG_LVGL_THREAD_STACK_SIZE
#endif
#endif /* LPKG_LVGL_DRAW_THREAD_STACK_SIZE */
...
#if LV_USE_OS
        lv_thread_init(&draw_sw_unit->thread, LV_THREAD_PRIO_HIGH, render_thread_cb, LPKG_LVGL_DRAW_THREAD_STACK_SIZE, draw_sw_unit);
#endif
    }

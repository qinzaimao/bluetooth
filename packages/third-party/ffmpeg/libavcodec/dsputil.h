...
#define float2fp(a)   ((int) ( (a) * (0x00010000) ))
#define fp2float(b)   ( ((float)(b) ) / ((float)(0x00010000)) )
#define fp2int(a) ( (a) / (0x00010000) )
#define int2fp(a) ( (a) * (0x00010000) )
#define float2fp32(x) ((long long)(0x0000000100000000*(x)))

typedef struct MYFFTComplex32
{
	long long re;
	long long im;
}MYFFTComplex32;

...
static inline const int ff_log2_16bit_c(unsigned int v)
{
    int n = 0;
    if (v & 0xff00) {
        v >>= 8;
...
static inline const int ff_ctz_c(int v)
{
...
/* We use the De-Bruijn method outlined in:
 * http://supertech.csail.mit.edu/papers/debruijn.pdf. */
static inline const int ff_ctzll_c(long long v)
{
...
static inline const unsigned ff_clz_c(unsigned x)
{

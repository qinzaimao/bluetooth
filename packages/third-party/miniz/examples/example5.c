...
int miniz_example_5(int argc, char *argv[])
{
   const char *pMode;
...
#include <finsh.h>
MSH_CMD_EXPORT_ALIAS(miniz_example_5, miniz_example_5, miniz example 5);
#elif defined(AIC_CONSOLE_BARE_DRV)
#include <console.h>
CONSOLE_CMD(miniz_example_5, miniz_example_5, "miniz example 5");
#endif

...
int miniz_example_1(int argc, char *argv[])
{
  uint step = 0;
  int cmp_status;
...
#include <finsh.h>
MSH_CMD_EXPORT_ALIAS(miniz_example_1, miniz_example_1, miniz example 1);
#elif defined(AIC_CONSOLE_BARE_DRV)
#include <console.h>
CONSOLE_CMD(miniz_example_1, miniz_example_1, "miniz example 1");
#endif

...
int miniz_example_4(int argc, char *argv[])
{
  int status;
...
#include <finsh.h>
MSH_CMD_EXPORT_ALIAS(miniz_example_4, miniz_example_4, miniz example 4);
#elif defined(AIC_CONSOLE_BARE_DRV)
#include <console.h>
CONSOLE_CMD(miniz_example_4, miniz_example_4, "miniz example 4");
#endif

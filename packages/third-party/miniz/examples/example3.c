...
int miniz_example_3(int argc, char *argv[])
{
  const char *pMode;
...
#include <finsh.h>
MSH_CMD_EXPORT_ALIAS(miniz_example_3, miniz_example_3, miniz example 3);
#elif defined(AIC_CONSOLE_BARE_DRV)
#include <console.h>
CONSOLE_CMD(miniz_example_3, miniz_example_3, "miniz example 3");
#endif

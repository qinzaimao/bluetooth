...
int miniz_example_2(int argc, char *argv[])
{
  int i, sort_iter;
  mz_bool status;
  size_t uncomp_size;
...
#include <finsh.h>
MSH_CMD_EXPORT_ALIAS(miniz_example_2, miniz_example_2, miniz example 2);
#elif defined(AIC_CONSOLE_BARE_DRV)
#include <console.h>
CONSOLE_CMD(miniz_example_2, miniz_example_2, "miniz example 2");
#endif

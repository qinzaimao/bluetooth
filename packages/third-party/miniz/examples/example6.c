...
int miniz_example_6(int argc, char *argv[])
{
  (void)argc, (void)argv;
...
#include <finsh.h>
MSH_CMD_EXPORT_ALIAS(miniz_example_6, miniz_example_6, miniz example 6);
#elif defined(AIC_CONSOLE_BARE_DRV)
#include <console.h>
CONSOLE_CMD(miniz_example_6, miniz_example_6, "miniz example 6");
#endif

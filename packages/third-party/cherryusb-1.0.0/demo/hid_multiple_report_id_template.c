...
#define HID_OUT_EP_SIZE     16
#define HID_OUT_EP_INTERVAL 2

#define USB_HID_CONFIG_DESC_SIZ       41

#define HID_KEYBOARD_REPORT_DESC_SIZE 123
#define HID_DATA_NUM 9
#define TEST_REPORT_ID 0x02
...
static const uint8_t hid_descriptor[] = {
    ...
    HID_INT_EP_SIZE,              /* wMaxPacketSize: 16 Byte max */
    0x00,
    ...
    0x03,                         /* bmAttributes: Interrupt endpoint */
    HID_OUT_EP_SIZE,              /* wMaxPacketSize: 16 Byte max */
    0x00,
...
/**
 * @brief HID Report
 * There is 2 report-id
 * The hid report of report-id 2 is the same as report-id 1, just for test
 */

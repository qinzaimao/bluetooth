...
#define QH_HLP_ITD(x)  (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x0) /* Isochronous Transfer Descriptor */
#define QH_HLP_QH(x)   (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x2) /* Queue Head */
#define QH_HLP_SITD(x) (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x4) /* Split Transaction Isochronous Transfer Descriptor */
#define QH_HLP_FSTN(x) (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x6) /* Frame Span Traversal Node */
...
#define ITD_NLP_ITD(x)  (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x0)
#define ITD_NLP_QH(x)   (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x2)
#define ITD_NLP_SITD(x) (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x4)
#define ITD_NLP_FSTN(x) (((uint32_t)(uintptr_t)(x) & ~0x1F) | 0x6)

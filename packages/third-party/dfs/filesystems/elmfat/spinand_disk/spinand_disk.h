 ...
 * @retval RES_OK Success.
 */
DRESULT spinand_disk_read(void *hdisk, uint8_t *buf, uint32_t sector, rt_size_t cnt);
 ...
 * @retval RES_OK Success.
 */
DRESULT spinand_disk_write(void *hdisk, const uint8_t *buf, uint32_t sector, rt_size_t cnt);

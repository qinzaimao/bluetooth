...
#define OS_LOWEST_PRIO           UCOS_LOWEST_PRIO   /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS            UCOS_MAX_EVENTS   /* Max. number of event control blocks in your application      */
#define OS_MAX_FLAGS             UCOS_MAX_FLAGS   /* Max. number of Event Flag Groups    in your application      */
#define OS_MAX_MEM_PART          UCOS_MAX_MEM_PART   /* Max. number of memory partitions                             */
#define OS_MAX_QS                UCOS_MAX_QS   /* Max. number of queue control blocks in your application      */
#define OS_MAX_TASKS             UCOS_MAX_TASKS   /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TLS_TBL_SIZE           0u   /* Size of Thread-Local Storage Table                           */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    UCOS_TASK_TMR_STK_SIZE   /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   UCOS_TASK_STAT_STK_SIZE   /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   UCOS_TASK_IDLE_STK_SIZE   /* Idle       task stack size (# of OS_STK wide entries)        */

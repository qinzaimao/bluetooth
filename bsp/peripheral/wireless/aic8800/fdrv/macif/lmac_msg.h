...
enum scan_msg_tag
{
    ...
    SCAN_START_CFM,     // 0x801
    /// End of scanning indication.
    SCAN_DONE_IND,      // 0x802
    /// Cancel scan request
    SCAN_CANCEL_REQ,    // 0x803
    /// Cancel scan confirmation
    SCAN_CANCEL_CFM,    // 0x804
...
enum
{
    ...
    /// Scanning start Confirmation.
    SCANU_START_CFM,            // 0x1001
    /// Join request
    SCANU_JOIN_REQ,             // 0x1002
    /// Join confirmation.
    SCANU_JOIN_CFM,             // 0x1003
    /// Scan result indication.
    SCANU_RESULT_IND,           // 0x1004
    /// Get Scan result request.
    SCANU_GET_SCAN_RESULT_REQ,  // 0x1005
    /// Scan result confirmation.
    SCANU_GET_SCAN_RESULT_CFM,  // 0x1006

    SCANU_VENDOR_IE_REQ,        // 0x1007
    SCANU_VENDOR_IE_CFM,        // 0x1008
    SCANU_START_CFM_ADDTIONAL,  // 0x1009
    SCANU_CANCEL_REQ,           // 0x100A
    SCANU_CANCEL_CFM,           // 0x100B
...
enum sm_msg_tag
{
    ...
    SM_CONNECT_CFM,                 // 0x1801
    /// Indicates that the SM associated to the AP
    SM_CONNECT_IND,                 // 0x1802
    /// Request to disconnect
    SM_DISCONNECT_REQ,              // 0x1803
    /// Confirmation of disconnection
    SM_DISCONNECT_CFM,              // 0x1804
    /// Indicates that the SM disassociated the AP
    SM_DISCONNECT_IND,              // 0x1805
    /// Request to start external authentication
    SM_EXTERNAL_AUTH_REQUIRED_IND,  // 0x1806
    /// Response to external authentication request
    SM_EXTERNAL_AUTH_REQUIRED_RSP,  // 0x1807

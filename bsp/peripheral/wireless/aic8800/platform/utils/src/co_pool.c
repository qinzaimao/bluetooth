                  ...
                  uint32_t elem_cnt)
{
    ...
    AIC_ASSERT_ERR((((intptr_t)elements) & 3) == 0);
    AIC_ASSERT_ERR((elem_size & 3) == 0);
    ...
    for (i = 0; i < elem_cnt; i++)
    {
        ...
        pool_hdr[i].element = (void*)((long)elements + (i * elem_size));
    }

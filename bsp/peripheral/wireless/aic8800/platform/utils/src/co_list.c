                    ...
                    struct co_list_hdr *element)
{
    // sanity check
    AIC_ASSERT_ERR(list != NULL);
    AIC_ASSERT_ERR((prev_element == NULL) || (prev_element->next == element));
    AIC_ASSERT_ERR(element != NULL);

		   ...
		   int line)
{
	...
	for (i = 0; i < NUM_SSID_FIELDS; i++) {
		...
		if (os_strncmp(var, field->name, strlen(var)) != 0)
			continue;
...
{
#if (PLF_HW_PXP == 1)
	const u8 fixed_psk[PMK_LEN] = {     // SSID:Test PW:12345678
		0xd0,0x78,0x28,0xfb,0x75,0x90,0x33,0x29,
		0x59,0xd1,0xaf,0xd9,0x0e,0x25,0xd5,0x80,
		0x19,0x54,0x12,0x60,0x32,0x7f,0x18,0x4e,
		0x1f,0x13,0x50,0xc3,0xc5,0xde,0x4d,0x03
	};
	wpa_printf(MSG_DEBUG, "[AIC] wpa_config_update_psk");
	memcpy(ssid->psk, fixed_psk, PMK_LEN);

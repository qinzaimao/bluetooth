...
#endif /* CONFIG_P2P */
	u8 freq_seg_idx;
	u8 op_class; // temporary usage, conf->op_class in wpas-2.10
...
aic_wps_status_notify aic_wps_status_notify_cb = NULL;
void aic_set_wps_status_cb(aic_wps_status_notify cb)
{
	aic_wps_status_notify_cb = cb;
}
...
#endif /* CONFIG_P2P */
#ifdef	CONFIG_AP
	if(aic_wps_status_notify_cb)
	{
		aic_wps_status_notify_cb(event);
	}
#endif
}

				   ...
				   struct wps_event_fail *fail)
{
	...
	hapd->wps_stats.failure_reason = (enum wps_error_indication)fail->error_indication;
		     ...
		     struct hostapd_bss_config *conf)
{
	...
	wps->wps_state = (enum wps_state)hapd->conf->wps_state;

...
/**
 * enum wpa_note_type - Notification type for application
 */
enum wpa_note_type {
	/**
	 * NOTE_P2P_PROV_DISC_REQ_RECVD - P2P provision discovery request received
	 */
	NOTE_P2P_PROV_DISC_REQ_RECVD,
};
...
#ifdef CONFIG_DRIVER_RWNX
extern const struct wpa_driver_ops wpa_driver_rwnx_ops; /* driver_rwnx.c */
#endif /* CONFIG_DRIVER_RWNX */

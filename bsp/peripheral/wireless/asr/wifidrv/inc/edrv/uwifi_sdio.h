...
#define SDIO_BLOCK_SIZE   32//32  //SDIO max transfer in one cmd53:32*512=16KB
#endif
#define SDIO_BLOCK_SIZE_DLD  SDIO_BLOCK_SIZE
...
//int asr_sdio_download_firmware(const struct firmware *fw_img);

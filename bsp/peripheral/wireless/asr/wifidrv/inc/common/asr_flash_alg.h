...
extern          void asr_flash_alg_read_buf_clr(void);
extern          void asr_flash_alg_cache_bypass(void);
extern          void asr_flash_alg_cache_enable(void);
extern          void asr_flash_alg_cache_flush(void);
extern          int  asr_flash_alg_init (void);
extern          int asr_flash_alg_erase(unsigned int cmd, unsigned long adr);
extern          int  asr_flash_alg_programpage (unsigned long adr,   // Program Page Function
                                  unsigned long sz,
                                  unsigned char *buf);
#ifdef _SPI_FLASH_240MHz_
extern          void asr_flash_alg_calibrate_shift(int prescaler);
#endif
#ifdef _SPI_FLASH_120MHz_
extern          void asr_flash_alg_set_clk_120(unsigned char en_120m);
#endif
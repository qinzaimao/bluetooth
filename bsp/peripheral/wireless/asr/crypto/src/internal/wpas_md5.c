...
static void MD5_memcpy(POINTER, POINTER, uint32_t);
static void MD5_memset(POINTER, int32_t, uint32_t);
 ...
 */
void wlan_MD5_Init (MD5_CTX *context)
                                       /* context */
{
...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context.
 */
void wlan_MD5_Update (MD5_CTX *context,
uint8_t *input,
uint32_t inputLen)
 ...
 */
void wlan_MD5_Final (uint8_t digest[16],
MD5_CTX *context)
                                    /* context */
{
  uint8_t bits[8];
 ...
 */
static void MD5_memset (POINTER output, int32_t value, uint32_t len)
{
...
*/
void asr_hmac_md5(uint8_t *text, int32_t text_len, uint8_t *key, int32_t key_len,uint8_t *digest)
{
        MD5_CTX context;
